...
const allCategories = [
  "All", "GA4", "GTM", "Analytics", "BigQuery",
  "Tracking", "CRO", "Attribution", "Server-Side", "ML", "Funnel", "Product",
];
      ...
      <section className="min-h-[60vh] flex flex-col justify-between px-6 md:px-12 lg:px-24 pt-40 pb-12 relative z-10 max-w-7xl mx-auto">
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-6 max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-light tracking-tight text-text-primary leading-[1.1]" variants={staggerItem}>
            Real results for<br />
            <span className="text-primary font-semibold">real clients</span>
          </h1>
          <p className="text-sm sm:text-base text-text-secondary font-light max-w-2xl leading-relaxed" variants={staggerItem}>
            How we've helped organisations across media, finance, healthcare, e-commerce and beyond
            unlock the power of their data — driving measurable outcomes with modern analytics engineering.
          </p>
        ...
        <div className="pointer-events-none absolute right-6 top-[calc(50%+40px)] hidden w-[38%] -translate-y-1/2 lg:block">
          <AnimatedHeroVisual icon={TrendingUp} title="Client outcomes" eyebrow="Case evidence" scene="data" />
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative rounded-3xl border border-border/50 bg-surface/40 backdrop-blur-xl px-8 py-14 sm:px-16 overflow-hidden text-center">
            ...
            <p className="text-sm text-text-secondary max-w-xl mx-auto mb-8">
              Let's talk about your analytics challenges. We'll design a measurement strategy that delivers results you can actually act on.
            </p>
            <a
              href="/contact"
