...
export default function DedicatedTeam() {
  ...
  const content: PageContent = {
    eyebrow: "SERVICES / AI TEAM AUGMENTATION",
    title: "Embed AI & ML Engineers in Your Team",
    intro:
    ...
    heroIcon: Users,
    heroScene: "team",
    heroTitle: "Team velocity",
    accent: "#4DA6FF",

    capsTitle: "Flexible Engagement Models",
    capsIntro:
    ...
    capabilities: [
      {
        ...
        desc: "Embed individual senior AI engineers, ML specialists, or data scientists directly into your development loop. You steer the roadmap; we handle the hiring, HR, and admin overhead, with vetted talent placed in under 10 days, direct control of your AI product backlog, and flexible, decoupled resource billing.",
      },
      {
        icon: Users,
        title: "Dedicated AI Squad",
        desc: "Deploy an autonomous, full-cycle AI delivery squad. ML engineers, data scientists, MLOps, QA, and a delivery lead. We own the roadmap and ship intelligent features to production, coordinating models and application code with model evaluation, QA, and progress audits built into every sprint.",
      },
    ],

    processTitle: "Key Value Propositions",
    processIntro:
    ...
    proofTitle: "Built Around Your AI Outcomes",
    proofIntro:
      "Every engagement runs under clear SLAs with senior talent embedded fast, so your roadmap keeps moving without recruiting drag or delivery risk.",
    highlights: [
      "Vetted AI/ML talent placed in under 10 days.",
      "100% IP, code, and trained models transferred to you.",
      "Model evaluation and QA built into every sprint.",
      "Managed HR, payroll, and continuity safeguards handled for you.",
    ],
